...
The full project --- the cleaning script, the analysis code, and a \texttt{README.md} describing the dataset, the cleaning process, the analysis, and these findings --- is uploaded to my GitHub repository for the internship: \url{https://github.com/AbdullahAmir06/ai-internship-abdullahamir}.
